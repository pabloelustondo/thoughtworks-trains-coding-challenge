...
var kiwiland3_1 = require("./kiwiland3");
var testsCases = [5];
...
var kiwiland = new kiwiland3_1.Kiwiland(); // CREATE THE GRAPH
...
checkAndPrint(kiwiland.routeDistance(["A", "E", "D"]), kiwiland3_1.NOROUTE);
// TEST CASE 6
...
function printTree(routeTree, destination, route) {
    if (route === void 0) { route = ""; }
    if (routeTree.town === destination) {
        console.log(route + destination);
    }
    for (var l in routeTree.links) {
        printTree(routeTree.links[l], destination, route + l);
    }
}
//# sourceMappingURL=kiwiland3_test.js.map